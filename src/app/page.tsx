  ...
  return (
    <div className="container mx-auto p-4 max-w-md pb-20">
      <header className="mb-6 pt-6">
        <h1 className="text-2xl font-bold text-foreground leading-tight">Hôm nay bạn muốn mặc gì? Để mình gợi ý nhé 💗</h1>
      </header>
          ...
          <Card className="h-full shadow-soft hover:shadow-soft-hover transition-card tap-scale cursor-pointer bg-white border-2 border-rose-100 group relative overflow-hidden">
            ...
            <CardContent className="flex flex-row items-center p-6 h-full gap-5">
              ...
              <div>
                ...
                <CardDescription className="text-sm font-medium text-muted-foreground mt-1 line-clamp-1">Stylist cá nhân của bạn</CardDescription>
              </div>
            </CardContent>
          </Card>
        </Link>
          ...
          <Card className="h-full shadow-soft hover:shadow-soft-hover transition-card tap-scale cursor-pointer border border-border/50 bg-white group">
            <CardContent className="flex flex-col items-center justify-center p-5 text-center h-full gap-3">
              ...
              <div className="space-y-1">
                <CardTitle className="text-base font-semibold">Tủ đồ cá nhân</CardTitle>
                <CardDescription className="text-xs">Quản lý trang phục</CardDescription>
              </div>
            </CardContent>
          </Card>
        </Link>
        ...
        <Link href="/history">
          <Card className="h-full shadow-soft hover:shadow-soft-hover transition-card tap-scale cursor-pointer border border-border/50 bg-white group">
            <CardContent className="flex flex-col items-center justify-center p-5 text-center h-full gap-3">
              ...
              <div className="space-y-1">
                <CardTitle className="text-base font-semibold">Lịch sử phối đồ</CardTitle>
                <CardDescription className="text-xs">Xem lại trang phục đã mặc</CardDescription>
              </div>
            </CardContent>
          </Card>
        </Link>
      ...
      <p className="text-center text-xs text-muted-foreground/60 mt-8">
        Dành 1-2 phút mỗi ngày để mặc đẹp hơn.
      </p>
    </div>
  )
}
